...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame])) {
        ...
        [_titleLabel setText:@"Airplay Active"];
...
- (void)layoutSubviews
{
    ...
    CGSize descriptionLabelSize = [[_descriptionLabel text] sizeWithFont:[_descriptionLabel font]];
