...
@property (readwrite, strong) UIView *playerTopBar;
...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        [_playerTopBar addSubview:_titleLabel];
        
        _playerTopBar = [[UIView alloc] init];
        [_playerTopBar setOpaque:NO];
        [_playerTopBar setBackgroundColor:[[UIColor blackColor] colorWithAlphaComponent:0.7]];
        
        _playerControlBar = [[UIView alloc] init];
        [_playerControlBar setOpaque:NO];
        [_playerControlBar setBackgroundColor:[[UIColor blackColor] colorWithAlphaComponent:0.7]];
        
        _playPauseButton = [[UIButton alloc] init];
        [_playPauseButton setImage:[UIImage imageNamed:@"play-button3"] forState:UIControlStateNormal];
        ...
        [_playerTopBar addSubview:_fullScreenButton];
        
        _progressView = [[UIProgressView alloc] init];
        _progressView.progressTintColor = [UIColor colorWithRed:31.0/255.0 green:31.0/255.0 blue:31.0/255.0 alpha:.8];
        ...
        [_videoScrubber setMaximumTrackTintColor:[UIColor lightGrayColor]];
        ...
        [_currentPositionLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:14.0f]];
        ...
        [_timeLeftLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:14.0f]];
        ...
        [_shareButton setImage:[UIImage imageNamed:@"share-button2"] forState:UIControlStateNormal];
        [_shareButton setShowsTouchWhenHighlighted:YES];
        [_playerTopBar addSubview:_shareButton];
        
        self.controlsEdgeInsets = UIEdgeInsetsZero;
        
        NSLog(@"Controls loaded");
    }
    return self;
}
...
- (void)layoutSubviews
{
    ...
    UIImage *shareImage = [UIImage imageNamed:@"share-button2"];
    ...
    if (!_fullscreen) {
        ...
        [_shareButton setFrame:CGRectMake(insetBounds.size.width - 50, insetBounds.origin.y + 10, shareImage.size.width, shareImage.size.height)];
    }
    ...
    /* [_playerTopBar setFrame:CGRectMake(bounds.origin.x,
     bounds.size.height - PLAYER_CONTROL_BAR_HEIGHT,
     bounds.size.width,
     PLAYER_CONTROL_BAR_HEIGHT)];*/
    [_playerTopBar setFrame:CGRectMake(0,
                                       0,
                                       bounds.size.width,
                                       50)];
    ...
    CGRect fullScreenButtonFrame = CGRectMake(10,
                                              0,
                                              PLAYER_CONTROL_BAR_HEIGHT,
                                              PLAYER_CONTROL_BAR_HEIGHT);
    ...
    if ([_airplayButton alpha] > 0) {
        ...
        [_volumeView setFrame:CGRectMake(bounds.size.width - 60,
...
- (void)setPlayer:(AVPlayer *)player
{
    ...
    [self addSubview:self.playerTopBar];
}
